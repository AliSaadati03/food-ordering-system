...
public class OrderCreateCommandHandler {
    ...
    private final OrderCreatedEventApplicationListener orderCreatedEventApplicationListener;

    public OrderCreateCommandHandler(CustomerRepository customerRepository, OrderDomainService orderDomainService, OrderRepository orderRepository, RestaurantRepository restaurantRepository, OrderDataMapper orderDataMapper, OrderCreatedEventApplicationListener orderCreatedEventApplicationListener) {
        this.customerRepository = customerRepository;
        this.orderDomainService = orderDomainService;
        this.orderRepository = orderRepository;
        this.restaurantRepository = restaurantRepository;
        this.orderDataMapper = orderDataMapper;
        this.orderCreatedEventApplicationListener = orderCreatedEventApplicationListener;
    }
    ...
    public CreateOrderResponse createOrder(CreateOrderCommand createOrderCommand) {
        ...
        orderCreatedEventApplicationListener.process(orderCreatedEvent);
