...
import dto.message.message.CustomerModel;
import dto.track.TrackOrderResponse;
import org.springframework.stereotype.Component;
import outbox.model.approval.OrderApprovalEventPayload;
import outbox.model.approval.OrderApprovalEventProduct;
import outbox.model.payment.OrderPaymentEventPayload;
...
public class OrderDataMapper {
    ...
    private List<OrderItem> orderItemsToItemEntries(List<dto.create.OrderItem> orderItems) {
